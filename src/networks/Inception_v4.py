...
from keras.layers import Dropout, Dense, Flatten, AveragePooling2D
...
class Inceptionv4:
    ...
    def model_constructor(self):
        base_model = applications.InceptionResNetV2(include_top=False, weights='imagenet', input_shape=(self.imgzs, self.imgzs, 3))
        x = base_model.output
